...
export const categories: Category[] = [
  ...
  { id: '2', slug: 'tech-explained', name: 'Tech Explained', description: 'Understand how modern technology works - APIs, Docker, Cloud Computing, and more', icon: 'Cpu', color: 'cyan', featured: true, termCount: 25 },
  ...
  { id: '4', slug: 'finance', name: 'Finance', description: 'Key financial concepts, metrics, and principles explained simply', icon: 'TrendingUp', color: 'emerald', featured: true, termCount: 54 },
  ...
  { id: '6', slug: 'marketing', name: 'Marketing', description: 'Strategies, channels, and metrics for reaching and engaging customers', icon: 'Megaphone', color: 'orange', featured: true, termCount: 70 },
  { id: '7', slug: 'sales', name: 'Sales', description: 'Techniques, methodologies, and metrics for driving revenue', icon: 'Handshake', color: 'green', featured: true, termCount: 49 },
  { id: '8', slug: 'product-management', name: 'Product Management', description: 'Frameworks and practices for building and managing successful products', icon: 'Layers', color: 'indigo', featured: true, termCount: 41 },
  ...
  { id: '16', slug: 'management', name: 'Management', description: 'Leadership, motivation, and effective team management concepts', icon: 'Users', color: 'slate', featured: true, termCount: 10 },
  { id: '17', slug: 'strategy', name: 'Strategy', description: 'Strategic frameworks and competitive analysis for business success', icon: 'Map', color: 'fuchsia', featured: true, termCount: 5 },
  { id: '18', slug: 'hr', name: 'Human Resources', description: 'People management, hiring, performance, and workplace culture', icon: 'UserCheck', color: 'stone', featured: false, termCount: 2 },
  { id: '19', slug: 'project-management', name: 'Project Management', description: 'Planning, executing, and delivering projects on time and budget', icon: 'ClipboardCheck', color: 'lime', featured: true, termCount: 3 },
  { id: '20', slug: 'business-strategy', name: 'Business Strategy', description: 'High-level choices that define how a business competes and grows', icon: 'LineChart', color: 'violet', featured: true, termCount: 4 },
]
