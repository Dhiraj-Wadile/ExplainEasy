...
export const marketingTerms: Concept[] = [
  ...
  },
  {
    ...
    subcategory: 'Metrics & Analytics',
    definition:
      'The LTV:CAC ratio compares the lifetime value of a customer to the cost of acquiring that customer. It is the most important metric for evaluating the efficiency of a businesss growth engine. A ratio of 3:1 or higher is generally considered healthy, while below 1:1 means you lose money on every customer.',
    simpleExplanation:
      'LTV:CAC tells you whether the money a customer brings in (LTV) justifies what you spent to get them (CAC).',
    example:
      'A SaaS company has LTV of ,000 and CAC of ,000. LTV:CAC = 5:1. This is excellent. They spend  to get  in lifetime value. If LTV were ,000 and CAC ,000, the ratio would be 0.67:1 - they lose money on every customer.',
    whyItMatters:
      'LTV:CAC is the key metric investors evaluate. A ratio below 1:1 means the business burns cash on every customer. Above 3:1 indicates a healthy business. Above 5:1 suggests you may be underinvesting in growth. The ratio guides pricing, marketing spend, and growth strategy.',
    relatedTerms: ['customer-lifetime-value', 'customer-acquisition-cost', 'payback-period', 'unit-economics'],
    interviewQuestions: [
      'What is a healthy LTV:CAC ratio?',
      'How do you improve LTV:CAC ratio?',
      'What does a low LTV:CAC indicate?',
      'How do investors evaluate LTV:CAC?',
    ],
    realCompanyExample:
      'Zoom has maintained an excellent LTV:CAC ratio throughout its growth. Their product-led growth model (free tier + viral adoption) kept CAC very low while enterprise subscriptions drove high LTV. This efficiency was key to Zooms rapid profitable growth.',
    faqs: [
      { question: 'What is the ideal LTV:CAC ratio?', answer: '3:1 is healthy. 5:1 is excellent. Below 1:1 is unsustainable. Above 10:1 suggests underinvestment in growth. Ideal range: 3:1 to 5:1.' },
      { question: 'How do you improve LTV:CAC?', answer: 'Increase LTV (upsell, improve retention, raise prices) or decrease CAC (optimize channels, improve conversion, leverage organic). Both sides give leverage.' },
      { question: 'Does LTV:CAC differ by industry?', answer: 'Yes. SaaS: 3-5:1 is standard. E-commerce: 2-3:1. Marketplace: 4-6:1 (network effects improve both LTV and CAC over time).' },
    ],
    references: [
      'Skok, D. (2015). The Startup Metrics. For Entrepreneurs.',
      'Croll, A., & Yoskovitz, B. (2013). Lean Analytics. OReilly Media.',
    ...
    tags: ['ltv-cac', 'unit-economics', 'saas-metrics', 'marketing-metrics', 'growth-metrics'],
    icon: 'Divide',
    difficulty: 'Intermediate',
    featured: false,
    popular: false,
  ...
  },
  {
    ...
    subcategory: 'Metrics & Analytics',
    definition:
      'Payback period is the time required to recover the cost of acquiring a customer (CAC) through their gross margin contribution. It measures how long until a customer becomes profitable. A shorter payback period indicates a more capital-efficient business. Investors typically want payback within 12 months.',
    simpleExplanation:
      'Payback period is how many months it takes for a customer to generate enough profit to cover what you spent acquiring them.',
    example:
      'A company has CAC of ,200 and monthly gross margin per customer of . Payback period = ,200 /  = 6 months. After 6 months, the customer has paid back their acquisition cost and is now generating pure profit.',
    whyItMatters:
      'Payback period determines how much capital you need to grow. Long payback periods require more funding. Short payback periods enable self-funded growth. Companies with <12 month payback can grow sustainably; >24 month payback requires significant external capital.',
    relatedTerms: ['customer-acquisition-cost', 'customer-lifetime-value', 'ltv-cac-ratio', 'unit-economics'],
    interviewQuestions: [
      'What is a good payback period?',
      'How do you calculate payback period?',
      'How does payback period affect fundraising?',
      'How do you reduce payback period?',
    ],
    realCompanyExample:
      'Shopify has a very short payback period (3-6 months) for their merchant subscriptions. This short payback enabled them to grow from a small startup to + revenue without requiring massive external capital. Profitable growth is driven by efficient unit economics.',
    faqs: [
      { question: 'What is a good payback period?', answer: '<6 months: exceptional. 6-12 months: good. 12-18 months: acceptable. >18 months: concerning. >24 months: requires external funding to grow.' },
      { question: 'How do you calculate payback period?', answer: 'Payback Period = CAC / (Monthly Revenue per Customer x Gross Margin). Or: Payback Period = CAC / Monthly Gross Margin per Customer.' },
      { question: 'Whats the difference between payback and payback for SaaS?', answer: 'SaaS often uses gross margin adjusted payback: CAC / (ARPU x Gross Margin %). This accounts for cost of delivering the service.' },
    ],
    references: [
      'Skok, D. (2015). The Startup Metrics. For Entrepreneurs.',
      'Sahlman, W. A. (1997). How to Write a Great Business Plan. Harvard Business Review.',
    ],
    tags: ['payback-period', 'unit-economics', 'cac', 'saas-metrics', 'capital-efficiency'],
    icon: 'Clock',
    difficulty: 'Intermediate',
    featured: false,
    popular: false,
  ...
  },
  {
    ...
    subcategory: 'Metrics & Analytics',
    definition:
      'Unit economics measure the direct revenues and costs associated with a particular business model on a per-unit basis. Units can be a customer, a transaction, a subscription, or a product. The two key metrics are CAC (Customer Acquisition Cost) and LTV (Lifetime Value). Healthy unit economics are essential for sustainable growth.',
    simpleExplanation:
      'Unit economics tells you whether you make or lose money on each customer or each sale - the fundamental profitability of your business model.',
    example:
      'A food delivery startup analyzes unit economics: Average order value: . Delivery fee: . Restaurant commission: . Delivery cost: . Marketing cost: . Unit profit per order =  +  -  -  = - per order. They lose money on every delivery.',
    whyItMatters:
      'Unit economics reveal whether a business model works before scaling. Many startups fail because they scale losing unit economics - they lose more money faster. Improving unit economics should precede growth. Investors always evaluate unit economics before funding.',
    relatedTerms: ['customer-acquisition-cost', 'customer-lifetime-value', 'ltv-cac-ratio', 'payback-period'],
    interviewQuestions: [
      'What are the key unit economics metrics?',
      'How do you improve unit economics?',
      'Why do investors care about unit economics?',
      'How do unit economics differ by business model?',
    ],
    realCompanyExample:
      'Uber initially had terrible unit economics - subsidizing rides heavily to gain market share. As they achieved scale and raised prices, unit economics improved. However, Uber did not become profitable until 2023 - 14 years after founding - due to persistent negative unit economics.',
    faqs: [
      { question: 'What are the most important unit economics metrics?', answer: 'CAC, LTV, LTV:CAC ratio, payback period, gross margin per unit, contribution margin, and churn rate.' },
      { question: 'What is a contribution margin?', answer: 'Revenue per unit minus variable costs per unit. Variable costs include COGS, delivery, processing fees, and variable marketing costs.' },
      { question: 'Can a company scale with negative unit economics?', answer: 'Temporarily, if they have investor funding. But eventually unit economics must become positive. Amazon had negative unit economics for years but their scale and efficiency improvements eventually made them profitable.' },
    ],
    references: [
      'Skok, D. (2015). The Startup Metrics. For Entrepreneurs.',
      'Croll, A., & Yoskovitz, B. (2013). Lean Analytics. OReilly Media.',
    ...
    tags: ['unit-economics', 'cac', 'ltv', 'saas-metrics', 'business-model'],
    icon: 'Calculator',
    difficulty: 'Advanced',
    featured: false,
    popular: false,
  ...
  },
  {
    ...
    subcategory: 'Metrics & Analytics',
    definition:
      'Churn rate (also called attrition rate) measures the percentage of customers who stop using a product or service during a given time period. Monthly churn is common for subscription businesses. Annual churn is used for longer-Concept contracts. Churn is the enemy of growth and directly impacts LTV.',
    simpleExplanation:
      'Churn rate is how many customers you lose each month or year - the percentage of customers who cancel their subscription or stop buying.',
    example:
      'A SaaS company starts the month with 10,000 subscribers. 300 cancel during the month. Monthly churn = 300 / 10,000 = 3%. Annualized churn = 1 - (1 - 0.03)^12 = 30.6%. This means the company loses ~31% of customers each year.',
    whyItMatters:
      'Churn is the most important metric for subscription businesses. High churn means you must constantly acquire new customers just to maintain revenue. Reducing churn by 5% increases profits by 25-95%. Low churn compounds growth over time.',
    relatedTerms: ['customer-retention', 'customer-lifetime-value', 'ltv-cac-ratio', 'payback-period', 'unit-economics'],
    interviewQuestions: [
    ...
    realCompanyExample:
      'Netflix has remarkably low monthly churn of 1-2%. Their billions invested in original content, personalized recommendations, and seamless user experience keep subscribers engaged. Low churn means each subscriber is worth significantly more over time.',
    faqs: [
      { question: 'What is a good churn rate?', answer: 'SaaS: <5% monthly, <10% annual (enterprise). <3% monthly, <30% annual (SMB). Consumer subscription: 5-10% monthly. E-commerce: not typically measured monthly, use annual retention.' },
      { question: 'How do you reduce churn?', answer: 'Improve onboarding (most churn happens early), provide excellent support, gather feedback proactively, launch retention campaigns, improve product, and re-engage at-risk customers.' },
      { question: 'Whats the difference between customer churn and revenue churn?', answer: 'Customer churn = customers lost. Revenue churn = revenue lost from cancellations and downgrades. Revenue churn is more important for companies with variable pricing.' },
    ],
    references: [
      'Fader, P. (2012). Customer Centricity. Wharton Digital Press.',
      'Reichheld, F. F. (1996). The Loyalty Effect. Harvard Business School Press.',
    ...
    tags: ['churn-rate', 'customer-churn', 'retention', 'saas-metrics', 'unit-economics'],
    icon: 'TrendingDown',
    difficulty: 'Intermediate',
    featured: false,
    popular: true,
  ...
  },
  {
    ...
    subcategory: 'Metrics & Analytics',
    definition:
      'Net Promoter Score (NPS) is a measure of customer loyalty and satisfaction based on one question: How likely are you to recommend our company to a friend or colleague? Respondents rate 0-10. Promoters (9-10), Passives (7-8), Detractors (0-6). NPS = %Promoters - %Detractors. Scores range from -100 to +100.',
    simpleExplanation:
      'NPS measures how likely your customers are to recommend you to others, giving a score from -100 to +100.',
    example:
      'A company surveys 1,000 customers: 500 are Promoters (9-10), 300 are Passives (7-8), 200 are Detractors (0-6). NPS = 50% - 20% = +30. An NPS of +30 is considered good; +50 is excellent; +70 is world-class.',
    whyItMatters:
      'NPS is the most widely used customer loyalty metric. It predicts growth - companies with high NPS grow 2x faster than competitors. NPS provides a simple, standardized benchmark that correlates with revenue growth. It also identifies areas for improvement through follow-up questions.',
    relatedTerms: ['customer-retention', 'customer-satisfaction', 'customer-lifetime-value', 'churn-rate', 'customer-success'],
    interviewQuestions: [
    ...
    realCompanyExample:
      'Apple has one of the highest NPS scores in technology (60+). This reflects strong customer loyalty driven by product quality, ecosystem lock-in, and exceptional retail experience. High NPS correlates with Apples ability to charge premium prices.',
    faqs: [
      { question: 'What is a good NPS?', answer: 'Below 0: poor. 0-30: needs improvement. 30-50: good. 50-70: excellent. Above 70: world-class. Average across industries is around +30.' },
      { question: 'How many responses do you need for reliable NPS?', answer: 'Minimum 100-200 responses for statistically significant results. Larger samples (1,000+) provide more reliable benchmarks.' },
      { question: 'What is the difference between NPS and CSAT?', answer: 'CSAT measures satisfaction with a specific interaction (How satisfied were you with X?). NPS measures overall loyalty and likelihood to recommend. NPS is more predictive of long-Concept growth.' },
    ],
    references: [
      'Reichheld, F. F. (2003). The One Number You Need to Grow. Harvard Business Review.',
      'Reichheld, F. F., & Markey, R. (2011). The Ultimate Question 2.0. Harvard Business Review Press.',
      'Bain & Company. (2025). Net Promoter System.',
    ],
    tags: ['nps', 'net-promoter-score', 'customer-loyalty', 'customer-satisfaction', 'customer-metrics'],
    icon: 'Star',
    difficulty: 'Beginner',
    featured: false,
    popular: true,
  ...
  },
  {
    ...
    subcategory: 'Digital Marketing',
    definition:
      'Affiliate marketing is a performance-based marketing model where businesses pay external partners (affiliates) a commission for driving sales or leads. Affiliates promote products through unique tracking links on websites, blogs, social media, or email. It is a low-risk model since payment is based on results.',
    simpleExplanation:
      'Affiliate marketing pays people a commission for every sale they send your way - you only pay for results.',
    example:
      'A tech blogger writes a review of a laptop and includes an Amazon affiliate link. If a reader clicks the link and buys the laptop, the blogger earns a 4-10% commission. Amazon pays nothing for readers who visit and do not buy.',
    whyItMatters:
      'Affiliate marketing drives 15-30% of e-commerce sales. It is a low-risk, performance-based channel with  upfront cost. Brands only pay for actual sales. It extends reach through thousands of partners who promote your products to their audiences.',
    relatedTerms: ['influencer-marketing', 'performance-marketing', 'referral-marketing', 'cpa', 'commission'],
    interviewQuestions: [
    ...
    realCompanyExample:
      'Amazon Associates is the largest affiliate program in the world, with millions of affiliates earning commissions on Amazon products. It drives 10-15% of Amazons total sales. Commissions range from 1-20% depending on product category.',
    faqs: [
      { question: 'What is a typical affiliate commission rate?', answer: 'Varies by industry: Physical products: 5-20%. Digital products: 20-50%. SaaS subscriptions: 20-30% of first year. High-ticket items: lower % but higher absolute value.' },
      { question: 'How do you find affiliates?', answer: 'Affiliate networks (ShareASale, CJ, Impact, Rakuten), recruit from your customer base, use affiliate marketplaces, and reach out to relevant content creators.' },
      { question: 'What is the difference between affiliate and referral marketing?', answer: 'Affiliate marketing: structured program, often managed through networks, open to anyone. Referral marketing: typically limited to existing customers, often integrated into the product experience.' },
    ],
    references: [
      'Fox, J. (2020). Affiliate Marketing: A Beginners Guide. Independently Published.',
      'Brown, D., & Hayes, N. (2008). Influencer Marketing. Butterworth-Heinemann.',
      'Amazon. (2025). Amazon Associates Program Guide.',
    ],
    tags: ['affiliate-marketing', 'performance-marketing', 'commission', 'amazon-associates', 'partner-marketing'],
    icon: 'Link',
    difficulty: 'Beginner',
    featured: false,
    popular: true,
